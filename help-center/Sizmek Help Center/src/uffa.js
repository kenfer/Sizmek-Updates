                ...
                if (appView) {
                    ...
                    appView.on("addReviewUI", function(reviewVer) {
                        ...
                        $("#rejectBtn").click(function() {
                            ...
                            $("#suggestEdit").css("width", "initial");
                            $("#suggestEdit").css("height", "initial");
                                        ...
                                        $.getJSON("/api/v2/help_center/sections/201249236.json", function(data) {
                                            ...
                                            $.ajax(createArticleAPI, {
                                                ...
                                                success: function(data) {
                                                    ...
                                                    $("#suggestEdit .loaderAnimation").attr("src", gSZMKloaderGIFURL);
                                                    ...
                                                    $.ajax(tickAPI, {
                                                        ...
                                                        submitCheck = true;
                                                        $("#suggestEdit .loaderAnimation").attr("src", assetsSubmitSuccess);
                                                        $("#suggestEdit .submitStatus").text("Version updated successfully.")
                                                    }).fail(function(xhr, textStatus, errorThrown) {
                                                        $.getJSON("https://jsonip.com/?callback=?", function(data) {
                                                            var showIP = data.ip;
                                                            $("#suggestEdit .loaderAnimation").attr("src", assetsSubmitFail);
                        ...
                        $("#previewBtn").click(function() {
                            ...
                            /* no more content type tags in title
                        ...
                        if (descriptionText == "") showError("What would you like to see in the new article?");
                            ...
                            $.getJSON("/api/v2/help_center/sections/201249236.json", function(data) {
                                ...
                                $.getJSON("/api/v2/help_center/sections/" + currSectionId + ".json", function(sectionData) {
                                    ...
                                    $("#requestArticle .loaderAnimation").attr("src", gSZMKloaderGIFURL);
                                    ...
                                    $.ajax(tickAPI, {
                                        ...
                                        textStatus, xhr) {
                                        submitCheck = true;
                                        $("#requestArticle .loaderAnimation").attr("src", assetsSubmitSuccess);
                                        $("#requestArticle .submitStatus").html("<br><br>Thank you! Your request has been received.")
                                    }).fail(function(xhr, textStatus, errorThrown) {
                                        $.getJSON("https://jsonip.com/?callback=?", function(data) {
                                            var showIP = data.ip;
                                            $("#requestArticle .loaderAnimation").attr("src", assetsSubmitFail);
                        ...
                        $.getJSON("/api/v2/users/me/session.json",
                            function(data) {
                                ...
                                $.getJSON("/api/v2/help_center/sections/201249236.json", function(data) {
                                    ...
                                    $("#useArticle .loaderAnimation").attr("src", gSZMKloaderGIFURL);
                                    ...
                                    $.ajax(tickAPI, {
                                        ...
                                        submitCheck = true;
                                        $("#useArticle .loaderAnimation").attr("src", assetsSubmitSuccess);
                                        $("#useArticle .submitStatus").html("Thank you! Your report has been received.")
                                    }).fail(function(xhr, textStatus, errorThrown) {
                                        $("#useArticle .loaderAnimation").attr("src", assetsSubmitFail);
                                        $.getJSON("https://jsonip.com/?callback=?", function(data) {
                                            var showIP = data.ip;
                    ...
                    if (reasonTag == "-") showError("Please select a reason from the list");
                        ...
                        $.getJSON("/api/v2/help_center/sections/201249236.json", function(data) {
                            ...
                            $.getJSON("/api/v2/help_center/articles/" + currArticleId + ".json", function(articleData) {
                                ...
                                $("#flagArticle .loaderAnimation").attr("src", gSZMKloaderGIFURL);
                                ...
                                $.ajax(tickAPI, {
                                    ...
                                    submitCheck = true;
                                    $("#flagArticle .loaderAnimation").attr("src", assetsSubmitSuccess);
                                    $("#flagArticle .submitStatus").html("<br><br>Thank you! Your report has been received.")
                                }).fail(function(xhr,
                                    textStatus, errorThrown) {
                                    $("#flagArticle .loaderAnimation").attr("src", assetsSubmitFail);
                                    $.getJSON("https://jsonip.com/?callback=?", function(data) {
                                        var showIP = data.ip;
